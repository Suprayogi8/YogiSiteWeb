...
<body>
    ...
    <main>
        <div class="contact-info">
            <h2>Kontak Kami</h2>
            <p><i class="fas fa-map-marker-alt"></i> Alamat: Jalan Contoh No. 123, Kota ABC</p>
            <p><i class="fas fa-phone"></i> Telepon: +62 123 456 789</p>
            <p><i class="fas fa-envelope"></i> Email: info@yogiwebsite.com</p>
            <p><i class="fas fa-clock"></i> Jam Kerja: Senin - Jumat, 09:00 - 18:00</p>
        </div>
    </main>
    <footer>
